...
export class TicketRedisAccumulator {
  /**
   * Ejecuta el pipeline de Redis post-transacción de manera asíncrona (fire-and-forget).
  ...
  static incrementAsync(
    ...
    // Fire-and-forget: ejecuta en segundo plano sin await para no bloquear la respuesta HTTP
    (async () => {
