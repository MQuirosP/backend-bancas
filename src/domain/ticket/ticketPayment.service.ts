...
import { ActivityType, Prisma, Role, TicketPayment, TicketStatus } from "../../generated/prisma/client";
import { CreatePaymentInput } from "../../api/v1/dto/ticketPayment.dto";
...
export interface PaymentWithRelations extends TicketPayment {
  ticket?: any;
  paidBy?: any;
  cached?: boolean;
}
