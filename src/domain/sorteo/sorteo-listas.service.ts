...
} from "../../api/v1/dto/sorteo-listas.dto";
...
export const SorteoListasService = {
    ...
    async excludeLista(
        ...
        CacheService.invalidateTag('cierre').catch((err:unknown) => {
            logger.warn({ layer: 'service', action: 'CACHE_INVALIDATE_ERROR', payload: { tag: 'cierre', error: (err as Error).message } });
