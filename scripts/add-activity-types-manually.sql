-- Script para agregar manualmente los nuevos ActivityType si no existen
-- Ejecutar este script si los valores no se agregaron correctamente
-- IMPORTANTE: Ejecutar fuera de una transacción (cada ALTER TYPE es una transacción separada)
